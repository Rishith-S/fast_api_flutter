...
m1= load_model('/Users/rishisaginala/Downloads/r/map/model_109600.h5')
m2 = load_model('/Users/rishisaginala/Downloads/r/map/map2sat.h5')
@app.post('/predict')
def predict(data:GAN):
    ...
    def tile(filename, dir_in, dir_out, d):
        ...
        img = Image.open('/Users/rishisaginala/Downloads/r/map/imageToSave.jpg')
        w, h = img.size
